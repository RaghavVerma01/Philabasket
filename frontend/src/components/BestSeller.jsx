        ...
        <div className='px-6 md:px-16 lg:px-24 relative z-10'>
            ...
            <div className='relative group/nav'>
                ...
                <button 
                    ...
                    className="hidden text-black lg:flex absolute -left-12 top-1/2 -translate-y-1/2 z-30 w-10 h-10 rounded-full items-center justify-center bg-white border border-gray-100 shadow-xl opacity-0 group-hover/nav:opacity-100 transition-all hover:bg-black hover:text-white"
                >
                    <ChevronLeft size={18} />
                </button>
                ...
                <button 
                    ...
                    className="hidden text-black  lg:flex absolute -right-12 top-1/2 -translate-y-1/2 z-30 w-10 h-10 rounded-full items-center justify-center bg-white border border-gray-100 shadow-xl opacity-0 group-hover/nav:opacity-100 transition-all hover:bg-black hover:text-white"
                >
                ...
                <div 
                    ...
                    className='flex overflow-x-auto gap-6 pb-10 pt-4 hide-scrollbar snap-x snap-mandatory scroll-smooth'
                >
                    {bestSeller.length > 0 ? bestSeller.map((item, index) => (
                        ...
                        >
                            ...
                            <div className="absolute -top-2 -left-2 z-20 pointer-events-none">
                                <div className="bg-[#bd002d] text-white w-10 h-10 md:w-12 md:h-12 rounded-full flex flex-col items-center justify-center shadow-lg border-2 border-white transform group-hover:rotate-12 transition-all">
                                    <span className="text-[5px] font-black leading-none opacity-60">RANK</span>
                                    <span className="text-sm md:text-lg font-black leading-none">0{index + 1}</span>
                                </div>
                            </div>
